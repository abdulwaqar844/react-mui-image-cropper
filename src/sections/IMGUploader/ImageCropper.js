...
const ImageCropper = ({ onClose, updateAvatar, imgSrc }) => {
  ...
  const [aspect, setAspect] = useState(2.3/1);
  ...
  async function onDownloadCropClick() {
    ...
    // let file;
    // if (blob) {
    //   file = new File([blob], `backgroundImage_image_${Math.floor(Date.now() / 1000)}.png`, {
    //     type: 'image/jpeg',
    //     quality:0.8
    //   });
    // }
        ...
        <Stack display="flex" flexDirection="column" alignItems="center">
          ...
          >
            <img
              ...
              style={{ transform: `scale(${scale}) rotate(${rotate}deg)`, maxHeight: '100vh' }}
              onLoad={onImageLoad}
            />
          </ReactCrop>
